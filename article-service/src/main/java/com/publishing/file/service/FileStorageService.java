...
public class FileStorageService {
    ...
    private void createDirectory(Integer articleId){
        this.fileStorageLocation = Paths.get(
                fileStorageProperties.getUploadDir() + "/" + articleId)
                .toAbsolutePath().normalize();
    ...
    public String storeFile(Integer articleId, MultipartFile file){
        createDirectory(articleId);
    ...
    public Resource loadFileAsResource(Integer articleId, String fileName){
        try {
            Path filePath = this.fileStorageLocation.resolve(articleId + "/" + fileName).normalize();
