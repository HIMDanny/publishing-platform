...
const SearchField: React.FC<SearchFieldProps> = ({ variant = 'light' }) => {
      ...
      >
        <path
          className={classNames({
            'fill-gray-50': variant === 'light',
            'fill-gray-800': variant === 'dark',
          })}
  ...
  return (
    <div className="relative w-full max-w-2xl">
      ...
      <input
        autoComplete="off"
        className={classNames(
          'w-full rounded-3xl border bg-transparent py-2 pl-14 pr-7',
          {
            'placeholder:text-gray-400': variant === 'light',
            'border-black placeholder:text-gray-700': variant === 'dark',
          },
        )}
        type="text"
        name="search"
